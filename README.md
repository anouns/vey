...
![Главный экран приложения VEY.AI](vey-v2/src/assets/hero.png)

На главном экране расположен чат, в котором пользователь общается с нейросетью. Слева — основная область диалога, справа — боковая панель с деревом файлов текущего проекта и переключателем моделей ИИ.
